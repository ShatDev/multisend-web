...
const StepThree = () => (
  <div className="step-three">
    ...
    <div className="mt-12">
      <div className="flex justify-center mb-4">
        ...
        <p className="text-base text-white font-semibold gradient_text pl-5 w-1/3">
          0x17458511BC8afd6F0550DA3180f35565F56cca03
        </p>
      </div>
      <div className="flex justify-center mb-4">
      ...
      <div className="flex justify-center mb-4">
        ...
        <p className="text-base text-white font-semibold gradient_text pl-5 w-1/3">10</p>
      </div>
      <div className="flex justify-center mb-4">
    ...
    <div className="flex justify-center mt-10">
      ...
      <a className="text-base  font-semibold text-red-500 ml-2" href="/">
        Edit again
      </a>
    </div>
    <div className="flex justify-center mt-10">
