    ...
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center justify-center text-white text-lg">
          ...
          <a className="mr-5 hover:text-gray-900">Drop</a>
          <a className="mr-5 hover:text-gray-900">Pricing</a>
          <a className="mr-5 hover:text-gray-900">Tutorial</a>
          <a className="mr-5 hover:text-gray-900">FAQ</a>
        </nav>
        {!active && <Button onClick={connect}>Connect Wallet</Button>}
        {active && <ConnectedButton balance={balance} account={account} logOut={logOut} />}
      </div>
    </header>
